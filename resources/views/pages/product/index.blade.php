            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{route('create-product')}}" class="btn btn-outline-secondary d-flex justify-content-between align-items-center gap-1"
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td class="action-td">{!! $product->action !!}</td>
                                </tr>
                            @endforeach
...
<script>
    function deleteProduct(pUUID) {
        const url = '/product/delete-' + pUUID
        deleteItem(url);
    }
