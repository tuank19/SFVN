...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <form class="form-horizontal" id="productForm" action="{{route('submit.edit-product',['uuid'=>$product->uuid])}}">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label validate-require" for="name">Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control validate-require" value="{{$product->name}}" id="name" name="name" placeholder="Product name...">
                        ...
                        <div class="col-sm-10">
                            <select id="category" class="form-control validate-require" name="category">
                                @foreach ($categories as $category)
                                    <option value="{{$category->uuid}}" @if($category->id == $product->category->id) selected @endif>{{$category->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control validate-require" id="price" value="{{$product->price}}" name="price">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control validate-require" id="description" name="description" rows="5">{{$product->description}}</textarea>
